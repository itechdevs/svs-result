  ...
  return (
    <View style={styles.legendTable}>
      <View style={styles.legendRow}>
        ...
        <Text style={[styles.legendTh, styles.lColInterval]}>
          Interval In{"\n"}Percent
        </Text>
        <Text style={[styles.legendTh, styles.lColGrade]}>Grade</Text>
        <Text style={[styles.legendTh, styles.lColGP]}>Grade{"\n"}Point</Text>
        <Text style={[styles.legendTh, styles.lColDesc, { borderRight: 0 }]}>
          Description
        </Text>
      </View>
      {GRADE_INTERVALS.map((row, i) => (
        <View key={i} style={styles.legendRow}>
          ...
          <Text style={[styles.legendTd, styles.lColInterval]}>
            {formatInterval(row.interval)}
          </Text>
          <Text style={[styles.legendTd, styles.lColGrade]}>{row.grade}</Text>
          <Text style={[styles.legendTd, styles.lColGP]}>{row.gp}</Text>
          <Text style={[styles.legendTd, styles.lColDesc, { borderRight: 0 }]}>
            {row.desc}
          </Text>
        </View>
      ))}
          ...
          <View style={styles.innerBorder}>
            ...
            <View style={styles.examTitleSection}>
              ...
              <Text style={styles.subtitle}>
                Academic Year: {data.academicYear.name}
              </Text>
            </View>
            ...
            <View style={styles.studentInfoSection}>
              <View style={styles.infoLine}>
                <Text style={styles.infoText}>
                  THE FOLLOWING ARE THE GRADES BY:{" "}
                </Text>
                <Text style={styles.infoUnderline}>
                  {data.student.name.toUpperCase()}
                </Text>
              ...
              <View style={[styles.infoLine, { marginTop: 4 }]}>
                <Text style={styles.infoText}>
                  IN THE FINAL EXAMINATION CONDUCTED BY SCHOOL ARE GIVEN BELOW.
                </Text>
              </View>
            </View>
                ...
                return (
                  <React.Fragment key={index}>
                    ...
                    {hasPr && (
                      <View style={rowStyle}>
                        <Text style={[styles.td, styles.colCode]}>{subject.subjectCode || ""}</Text>
                        <Text style={[styles.td, styles.colSubject]}>{subject.subject.toUpperCase()} (PR/IN)</Text>
            ...
            <View style={styles.legendSection}>
              <View style={[styles.legendLeft, { paddingRight: 4 }]}>
                ...
                <Text style={styles.legendNote}>
                  1. One Credit Hour Equals To 32 Working Hours.
                </Text>
                <Text style={styles.legendNote}>
                  2. INTERNAL(IN): This Covers The Participation,
                  Practical/Project Works & Terminal Examination.
                </Text>
                <Text style={styles.legendNote}>
                  3. EXTERNAL(TH): This Covers Written External Examination.
                </Text>
                <View
                  style={{
                    flexDirection: "row",
              ...
              <View style={styles.legendRight}>
                <Text style={[styles.legendTitle, { textAlign: "center" }]}>
                  Intervals and Grade
                </Text>
                <GradeIntervalTable />
              </View>
