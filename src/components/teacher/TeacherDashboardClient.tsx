...
import { ClipboardList, AlertTriangle, CalendarClock, ChevronRight, Bell } from "lucide-react";
  ...
  const kpis = [
    {
      ...
      value: String(templatesData.length),
    ...
    },
    {
      ...
      value: String(reExamStats.pending),
      sub: "Require action",
      danger: true,
    ...
    },
    {
      ...
      value: String(reExamStats.scheduled),
    ...
    >
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Your teaching activity and pending actions</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-card text-card-foreground border border-border rounded-xl shadow-sm p-6 flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-sm font-bold text-foreground">Re-Exam Alerts</h2>
          </div>
          ...
          <div className="flex flex-col gap-3 flex-1">
            {reExamAlerts.length === 0 ? (
              ...
              reExamAlerts.map((s) => (
                <div key={s.id} className="bg-muted/40 border border-border rounded-lg p-3">
