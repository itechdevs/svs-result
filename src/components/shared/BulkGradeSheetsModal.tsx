...
export default function BulkGradeSheetsModal({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-6 text-slate-900">
      ...
      >
        {/* Header */}
        <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-slate-50/50 no-print">
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">
              Bulk Grade Sheets ({students.length} students)
            </span>
          </div>
          <div className="flex items-center gap-2">
            <button
...
function GradeSheetPage({
  ...
  const mergedScoresList = buildMergedScores(student.scores);
  const gpa = computeGpa(mergedScoresList);
  const rank =
    (student as any).rank ?? (student as any).classRank ?? 3;

  const gradeIntervals: [number, string, string, string, string][] = [
  ...
  return (
    <div
      className={cn(
        'bg-white shadow-xl mx-auto p-8 border-t-[16px] border-[#002045] min-h-[840px] w-full max-w-[210mm] text-slate-900 font-sans printable-sheet',
        !isLast && 'mb-8 print:mb-0 print:page-break-after-always',
      )}
    >
        ...
        <div>
          ...
          <div className="flex items-center justify-center gap-4 relative mb-6">
            <img
              ...
              className="w-20 h-20 object-contain absolute left-2"
              alt="Sanskar Logo"
            />
            <div className="text-center w-full">
              <h1 className="text-[20px] font-black text-[#002045] uppercase tracking-wide leading-tight font-sans">
                SANSKAR VIDHYAPITH SCHOOL
              </h1>
              <p className="text-[12px] font-bold text-[#002045] tracking-wide mt-0.5 font-sans">
                Balkhu, Kathmandu
              </p>
              <p className="text-[10px] font-semibold text-[#002045] tracking-wider mt-0.5 font-sans">
                Phone: 9802036680 | Email: sanskarvschool@gmail.com
              </p>
            </div>
          </div>
          ...
          <div className="text-center my-4 space-y-1">
            <h2 className="text-[11px] font-extrabold text-[#002045] uppercase tracking-widest font-sans">
              FINAL EXAMINATION
            </h2>
            <h3 className="text-[14px] font-black text-[#002045] uppercase tracking-widest border-b border-[#002045] pb-1.5 inline-block px-8 font-sans">
              GRADE SHEET
            </h3>
          </div>
          ...
          <div className="text-[10.5px] text-[#002045] font-semibold my-6 space-y-3 leading-relaxed font-sans">
            <div className="flex flex-wrap items-end gap-x-1 gap-y-2">
              ...
              <span className="border-b border-[#002045] px-2 font-black text-center grow max-w-[380px] uppercase">
                {student.name}
              </span>
              <span>ROLL NO:</span>
              <span className="border-b border-[#002045] px-2 font-bold text-center w-12">
                {student.rollNo}
              </span>
              <span>GRADE:</span>
              <span className="border-b border-[#002045] px-2 font-bold text-center w-24 uppercase">
                {student.class}
              </span>
            </div>
            <div className="flex flex-wrap items-end gap-x-1 gap-y-2">
              <span>IN THE FINAL EXAMINATION CONDUCTED IN</span>
              <span className="border-b border-[#002045] px-2 font-bold text-center w-16">
                2082
              </span>
              <span>B.S. (</span>
              <span className="border-b border-[#002045] px-2 font-bold text-center w-16">
          ...
          <table className="w-full text-[10.5px] border-collapse border border-[#002045] mb-4 font-sans">
            <thead>
              <tr className="bg-[#f0f4f8] text-[#002045]">
                <th className="border border-[#002045] py-2 px-3 text-left font-bold w-[45%]">
                  SUBJECTS
                </th>
                <th className="border border-[#002045] py-2 px-2 text-center font-bold w-[20%]">
                  GRADE POINT (GP)
                </th>
                <th className="border border-[#002045] py-2 px-2 text-center font-bold w-[15%]">
                  GRADE
                </th>
                <th className="border border-[#002045] py-2 px-3 text-left font-bold w-[20%]">
                  REMARKS
                </th>
              </tr>
            </thead>
            <tbody>
              {mergedScoresList.map((scoreItem, sIdx) => (
                <tr key={sIdx} className="text-[#002045]">
                  <td className="border border-[#002045] py-2 px-3 font-bold uppercase">
                    {scoreItem.subject}
                  </td>
                  <td className="border border-[#002045] py-2 px-2 text-center font-mono font-bold">
                    {scoreItem.gp}
                  </td>
                  <td className="border border-[#002045] py-2 px-2 text-center font-bold">
                    {scoreItem.grade}
                  </td>
                  <td className="border border-[#002045] py-2 px-3 font-semibold">
                    {scoreItem.remark}
                  </td>
                </tr>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 text-[9px] text-[#002045] font-sans">
              ...
              <ol className="list-decimal pl-4 space-y-1 leading-normal font-medium">
                ...
                <li className="font-bold flex items-center gap-1 mt-0.5">
                  ...
                  <div className="inline-flex flex-col items-center text-[8px] leading-none align-middle font-normal">
                    <span className="border-b border-[#002045] pb-0.5 px-1">
                      &Sigma;(Total Obtained)*100
                    </span>
            ...
            <div className="md:col-span-5">
              <div className="text-center font-bold text-[#002045] mb-1.5 text-[9.5px]">
                Intervals and Grade
              </div>
              <table className="w-full text-[8px] border-collapse border border-[#002045] text-center font-medium">
                <thead>
                  <tr className="bg-[#f0f4f8] font-bold">
                    ...
                    <th className="border border-[#002045] py-0.5 px-1">
                      Interval In Percent
                    </th>
                    <th className="border border-[#002045] py-0.5 px-1">
                      Grade
                ...
                <tbody>
                  {gradeIntervals.map(([sn, interval, grade, gp, desc]) => (
                    <tr key={sn}>
                      <td className="border border-[#002045] py-0.5">{sn}</td>
                      <td className="border border-[#002045] py-0.5">
                        {interval}
                      </td>
                      <td className="border border-[#002045] py-0.5 font-bold">
                        {grade}
                      </td>
                      <td className="border border-[#002045] py-0.5 font-bold">
                        {gp}
        ...
        <div className="mt-10">
          <div className="flex justify-between items-end text-[#002045] font-sans">
            <div className="text-center w-44">
              <div className="border-t border-[#002045] pt-1 text-[9.5px] font-bold">
                CLASS TEACHER
              </div>
            </div>
            <div className="text-center w-44">
